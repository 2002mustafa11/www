...
<body>
    ...
    <div class="container mt-5"> 
        <h2 class="mb-4">نواقس</h2>
        <a href="{{ route('Shortage.create') }}" class="btn btn-primary mb-3">اضافه</a>

        {{-- <a href="{{ route('accessorySale.index',["all" => true]) }}" class="btn btn-primary mb-3">كل الاجهزة</a>
        ...
        @endif
        <table id="accessoryShortage" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>نوع</th>
                    <th>نوع الجهاز</th>
            ...
            <tbody>
                @foreach($accessoryShortage as $receipt)
                    <tr >
