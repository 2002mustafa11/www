...
<body>
    ...
    <div class="container mt-5">
        ...
        <a href="{{ route('device_receipts.completed.all', ["all" => true]) }}" class="btn btn-primary mb-3">كل الأجهزة</a>
        <a href="{{ route('device_receipts.completed') }}" class="btn btn-secondary mb-3">أجهزة اليوم</a>
