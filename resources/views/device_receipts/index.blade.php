...
<body>
    ...
    <div class="container mt-5">
        ...
        <a href="{{ route('device_receipts.index.all', ["all" => true,"status" => 'pending']) }}" class="btn btn-primary mb-3">pendingكل الأجهزة</a>
        <a href="{{ route('device_receipts.index.all', ["all" => true,"status" => 'completed']) }}" class="btn btn-primary mb-3">completedكل الأجهزة</a>
        <a href="{{ route('device_receipts.index.all', ["all" => true,"status" => 'rejected']) }}" class="btn btn-primary mb-3">rejectedكل الأجهزة</a>
        <a href="{{ route('device_receipts.index') }}" class="btn btn-secondary mb-3">أجهزة اليوم</a>
        {{-- <a href="{{ route('device_receipts.completed') }}" class="btn btn-secondary mb-3">أجهزة completed</a>
        <a href="{{ route('device_receipts.rejected') }}" class="btn btn-secondary mb-3">أجهزة rejected</a> --}}
    ...
    @foreach($deviceReceipts as $receipt)
        <tr>
            ...
            <td>
                @livewire('update-status', ['deviceReceipt' => $receipt], key($receipt->id))
