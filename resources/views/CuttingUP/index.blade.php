...
<body>
    ...
    <div class="container mt-5">
        <h2 class="mb-4">تقطيع علي الرف</h2>
         <a href="{{ route('CuttingUP.create') }}" class="btn btn-secondary mb-3">اضافة</a>
        ...
        <table id="CuttingsTable" class="table table-striped table-bordered">
            ...
            <tbody>
                @foreach($CuttingUPs as $receipt)
                    <tr>
                        <td>
                            {{ $receipt->id }}
                        </td>
                        <td>
                            <a href="{{ route('CuttingUP.edit', ['CuttingUP' => $receipt->id]) }}" class="btn btn-secondary mb-3">edit</a>
